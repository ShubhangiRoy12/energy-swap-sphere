...
const Footer = () => {
  return (
    <footer className="w-full bg-background/50 backdrop-blur-md border-t border-border mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-foreground/70">
              An AI-powered energy marketplace for efficient and transparent trading of renewable energy.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-sm text-foreground/70 hover:text-energy-blue-light transition-colors">Documentation</a></li>
              <li><a href="#" className="text-sm text-foreground/70 hover:text-energy-blue-light transition-colors">API Reference</a></li>
              <li><a href="#" className="text-sm text-foreground/70 hover:text-energy-blue-light transition-colors">Status</a></li>
              <li><a href="#" className="text-sm text-foreground/70 hover:text-energy-blue-light transition-colors">Support</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-sm text-foreground/70 hover:text-energy-blue-light transition-colors">About</a></li>
              <li><a href="#" className="text-sm text-foreground/70 hover:text-energy-blue-light transition-colors">Blog</a></li>
              <li><a href="#" className="text-sm text-foreground/70 hover:text-energy-blue-light transition-colors">Careers</a></li>
              <li><a href="#" className="text-sm text-foreground/70 hover:text-energy-blue-light transition-colors">Contact</a></li>
            </ul>
          </div>
        </div>
